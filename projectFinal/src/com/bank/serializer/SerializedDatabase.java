...
public class SerializedDatabase implements Serializable {
  ...
  private void addUsers() throws ConnectionFailedException {
  ...
  private void extractUsers() throws ConnectionFailedException, IllegalObjectTypeException, 
      IllegalInputParameterException, IllegalAmountException, ItemNotFoundException {
    // stores the current 
   ...
   * @param oldUser the user object that we get data from
   * @param insertedId the id of the new user
   ...
   */
  private void bindAccounts(User oldUser, int insertedId) throws ItemNotFoundException,
