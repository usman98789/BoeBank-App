...
public class InitializeDatabase {
  ...
  private static void initializeRoleTable(Connection connection) {
    ...
    try {
      ...
      System.out.println("Unable to initialize role table.");
      e.printStackTrace();
    }
  }
  ...
  private static void initializeAccountTypes(Connection connection) {
    ...
    try {
      ...
      System.out.println("Unable to initialize account types.");
      e.printStackTrace();
    }
  }
  ...
  private static int initializeFirstAccount(Connection connection) {
    ...
    try {
      ...
      System.out.println("Unable to initialize first account.");
      e.printStackTrace();
      return -1;
    }
  }
